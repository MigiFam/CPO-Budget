...
export function FundingSourceDetailPage() {
  ...
  // TypeScript guard - this should never happen due to checks above, but just in case
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 flex items-start gap-3">
          <AlertCircle className="w-6 h-6 text-red-600 flex-shrink-0 mt-0.5" />
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-red-900 mb-1">Invalid Funding Source Data</h3>
            <p className="text-red-700 mb-4">
              The funding source data is invalid or corrupted.
            </p>
            <Link
              to="/funding-sources"
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
